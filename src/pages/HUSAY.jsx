  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      <div className="mb-6">
        ...
        <div className="mt-3 h-1 w-24 sm:w-32 bg-gradient-to-r from-orange-500 to-amber-500 rounded-full"></div>
      </div>
      ...
      <div className="bg-white/80 backdrop-blur border border-gray-200 rounded-2xl shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 p-4 sm:p-5 border-b">
          ...
          <button className="bg-gradient-to-r from-orange-500 to-amber-500 text-white px-4 py-2 rounded-lg text-sm shadow hover:scale-105 transition w-full sm:w-auto">
            + Add Scholar
          </button>
        </div>
          ...
          <table className="w-full text-xs sm:text-sm min-w-[600px]">
            ...
            <thead className="text-gray-500 uppercase">
              <tr>
                ...
                <th className="text-left px-4 sm:px-6 py-3">Field</th>
  ...
  return (
    <tr className="border-t hover:bg-gray-50 transition">
      ...
      <td className="px-4 sm:px-6 py-3 sm:py-4 flex items-center gap-2 sm:gap-3">
        <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-orange-500 text-white flex items-center justify-center font-bold text-sm">
          {name.charAt(0)}
        </div>
        <span className="font-medium text-sm">{name}</span>
      </td>

      <td className="px-4 sm:px-6 py-3 sm:py-4 text-sm">{field}</td>
      ...
      <td className="px-4 sm:px-6 py-3 sm:py-4 text-right">
        <button className="text-orange-600 hover:underline text-xs sm:text-sm mr-2 sm:mr-3">
          Edit
        </button>
